...
class Attack():
    ...
    def catalogue(self,name):
        self.name=name
        name=name.replace("\n","")
        attacks=[["scortch",10],["burn",8],["incinerate",15],["cremate",20],
                 ["flambe",5],["cut",8],["blizard",10],["avalanche",15],
                 ["freeze",5],["ice age",20],["icecle",8],["gust",8],
                 ["wind sythe",15],["sky wall",0],["heal",-10]]
...
#------------------------------------ITEMS---------------------------------------------
    def load_items_screen(self):
        ...
        def on_draw():
            ...
            attack_boost_small_image=pyglet.image.load("assets\items\attack_boost_small_beta.png").blit(250,600)
